                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered" style="width:100%">
                      ...
                      <tbody>
                      <?php
                          $expense = mysqli_query($conx, 'SELECT * FROM expense_tbl ORDER BY id DESC' );
                          $c = 1;
                          while($row = mysqli_fetch_array($expense)){
                            ...
                            echo '<td><b>&#x20A6;'.number_format($row['paid_amount']).'</b></td>';
                            echo '<td><b>&#x20A6;'.number_format($row['total_amount']).'</b></td>';
                            echo '<td>'.$row['expense_by'].'</td>';
